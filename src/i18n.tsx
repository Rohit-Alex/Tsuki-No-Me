...
const translationChile = { WELCOME: "bienvenidos", TODOS: 'RECHAZADO',TODO_DETAILS: 'Todo detalles',DYNAMIC_PARALLEL: 'Paralelo dinámico', PENDING_APPROVAL: 'En attente de validation', REJECTED: 'Rejeté', PUBLISHED: 'Publié', ALL: 'Tout'  };
i18n
